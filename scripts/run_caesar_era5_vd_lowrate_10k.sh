...
OUTPUT_DIR="${CAESAR_VD_LOWRATE_DIR:-$ROOT/checkpoints/caesar_era5_vd_lowrate_10k}"
LOG_DIR="${CAESAR_VD_LOWRATE_LOG_DIR:-$ROOT/logs/caesar_era5_vd_lowrate_10k}"
...
common=(
  ...
  --wandb_group vd-lowrate-from-original-10k
  --wandb_tags era5 daily-cadence low-rate from-original codec-rd-screen
  --require_wandb
  --device cuda:0
)
...
launch 2 V v_lr1em5_lam1em4 1e-4
launch 3 V v_lr1em5_lam3em4 3e-4
launch 4 V v_lr1em5_lam1em3 1e-3
launch 5 D d_s1_lr1em5_lam1em4 1e-4
launch 6 D d_s1_lr1em5_lam3em4 3e-4
launch 7 D d_s1_lr1em5_lam1em3 1e-3
