    ...
    if args.ckpt == "both":
        return [
            ...
            (args.model_type, "finetuned",
             args.tuned_checkpoint or f"{ckpt_base}/caesar_{model_tag}{args.tuned_suffix}.pt",
             test_data, nf, use_diffusion),
        ]
...
def main():
    ...
    parser.add_argument("--tuned_checkpoint", type=str, default=None,
                        help="Explicit tuned checkpoint used by --ckpt finetuned/both.")
