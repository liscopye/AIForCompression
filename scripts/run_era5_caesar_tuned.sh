#!/bin/bash
#SBATCH --job-name=era5_caesar_tuned
#SBATCH --partition=gpu_5090
#SBATCH --gpus=1
#SBATCH --cpus-per-task=4
#SBATCH --output=/data/run01/scxj523/zsh/project/AIForCompression/logs/era5_caesar_tuned_%j.log
#SBATCH --error=/data/run01/scxj523/zsh/project/AIForCompression/logs/era5_caesar_tuned_%j.log
