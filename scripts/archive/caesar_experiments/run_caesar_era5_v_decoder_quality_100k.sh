...
DECODER_10K_SOURCE="$ROOT/checkpoints/caesar_era5_v_decoder_quality_highlr_10k/decoder_lr3em4.pt"
...

{
  ...
  sha256sum "$LOWRATE_SOURCE" "$DECODER_10K_SOURCE"
...
launch 6 from_decoder10k_lr1em4 "$DECODER_10K_SOURCE" 1e-4
launch 7 from_decoder10k_lr3em5 "$DECODER_10K_SOURCE" 3e-5
